...
models_dir = "models/PPO/Intraday"
best_model_dir = "models/PPO/Intraday/BestModel"
logdir = "logs/Intraday"
...
def trainModelOnASingleDataset():
    ...
    model = PPO('MlpPolicy', env, verbose=1, tensorboard_log=logdir, learning_rate=0.005, ent_coef=0.2, n_epochs=32,
                batch_size=16, gamma=0.99, clip_range=0.001, policy_kwargs={'net_arch': [16, 32, 64, 64]})
